...
## 웹개발자가 왜 앱 포폴을 넣었을까?
비록 앱이지만 Soket.io , Firebase 는웹에서도 유용하게 쓰일 것 같아서 웹개발자로서 의미없는 경험이라고 보기는 어렵다!
...
### `성장한점`
- 팀원 모두 열심히 한 것 + 팀장으로서 모든 트러블 슈팅을 도맡아했다. 특히 merge할때 오류를 주도적으로 해결했다!
- Socket.io 와 Firebase realtime Database 를 통해 실시간 채팅을 구현했다.
  앱이 익숙치 않아 웹에서 먼저 구현해보았다. 어렵다면 내가 익숙한 환경에서 적응하는 것도 좋은 방법이라고 생각해서이다!
